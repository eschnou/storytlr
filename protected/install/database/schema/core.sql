...
--
-- Do not make changes to this file, any subsequent updates to the database
-- should be triggered through update scripts and increase of the required version number.
